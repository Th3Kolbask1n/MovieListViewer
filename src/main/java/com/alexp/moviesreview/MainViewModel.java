...
public class MainViewModel extends AndroidViewModel {
    ...
    public void loadMovies(){
        ...
        return;
            ...
            Disposable disposable = ApiFactory.apiService.loadMoviesList(page)
                    ...
                    .subscribe(new Consumer<MovieResponse>() {
                        ...
                        public void accept(MovieResponse movieResponse) throws Throwable {
                            List<Movie> loadedMovies = movieList.getValue();
                            if(loadedMovies!=null)
                            {

                                loadedMovies.addAll(movieResponse.getMovies());
                                movieList.setValue(loadedMovies);
                            }
                            else {
                                movieList.setValue(movieResponse.getMovies());
                            }
                            page++;
                        }
